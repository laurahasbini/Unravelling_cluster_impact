...
filtered_df_info.to_csv(PATH_TRACKS+"tracks_"+filt+"_24h_"+period+"_info.csv", index=False)
filtered_df.to_csv(PATH_TRACKS+"tracks_"+filt+"_24h_"+period+".csv", index=False)
